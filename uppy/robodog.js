...
},{"./Plugin":90,"./supportsUploadProgress":92,"@uppy/store-default":140,"@uppy/utils/lib/Translator":152,"@uppy/utils/lib/generateFileID":158,"@uppy/utils/lib/getFileNameAndExtension":163,"@uppy/utils/lib/getFileType":164,"@uppy/utils/lib/getTimeStamp":168,"cuid":13,"mime-match":42,"namespace-emitter":43,"prettier-bytes":48}],92:[function(require,module,exports){
...
},{"./AddFiles":94,"./AddFilesPanel":95,"./FileCard":97,"./FileList":100,"./PickerPanelContent":102,"./PickerPanelTopBar":103,"@uppy/utils/lib/isTouchDevice":172,"classnames":9,"preact":47,"preact-css-transition-group":46}],97:[function(require,module,exports){
function _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
},{"./components/Dashboard":96,"./components/icons":104,"@uppy/core":91,"@uppy/informer":114,"@uppy/status-bar":139,"@uppy/thumbnail-generator":141,"@uppy/utils/lib/Translator":152,"@uppy/utils/lib/findAllDOMElements":156,"@uppy/utils/lib/getDroppedFiles":160,"@uppy/utils/lib/toArray":178,"cuid":13,"resize-observer-polyfill":52}],106:[function(require,module,exports){
/**
...
},{"@uppy/core":91,"@uppy/utils/lib/findDOMElement":157,"@uppy/utils/lib/toArray":178,"get-form-data":35}],112:[function(require,module,exports){
function _inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }
...
},{"./AuthView":116,"./Browser":118,"./Loader":123,"@uppy/utils/lib/generateFileID":158,"@uppy/utils/lib/getFileType":164,"@uppy/utils/lib/isPreviewSupported":171,"preact":47}],125:[function(require,module,exports){
...
},{"@uppy/core":91,"@uppy/utils/lib/findDOMElement":157,"@uppy/utils/lib/toArray":178}],127:[function(require,module,exports){
function _assertThisInitialized(self) {
  if (self === void 0) {
    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
  }
...
},{"./addTransloaditPlugin":130,"./createUppy":131,"@uppy/utils/lib/toArray":178}],137:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"./StatusBarStates":138,"@uppy/utils/lib/prettyETA":175,"classnames":9,"lodash.throttle":41,"preact":47,"prettier-bytes":48}],138:[function(require,module,exports){
module.exports = {
  'STATE_ERROR': 'error',
  'STATE_WAITING': 'waiting',
  'STATE_PREPROCESSING': 'preprocessing',
...
},{"./StatusBar":137,"./StatusBarStates":138,"@uppy/core":91,"@uppy/utils/lib/Translator":152,"@uppy/utils/lib/getBytesRemaining":159,"@uppy/utils/lib/getSpeed":167}],140:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"@uppy/core":91,"@uppy/utils/lib/dataURItoBlob":154,"@uppy/utils/lib/isObjectURL":170,"@uppy/utils/lib/isPreviewSupported":171}],142:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"@uppy/companion-client":88,"@uppy/core":91,"@uppy/utils/lib/emitSocketProgress":155,"@uppy/utils/lib/getSocketHost":166,"@uppy/utils/lib/limitPromises":173,"@uppy/utils/lib/settle":177,"tus-js-client":77}],149:[function(require,module,exports){
function _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
},{"./UrlUI.js":149,"./utils/forEachDroppedOrPastedUrl":151,"@uppy/companion-client":88,"@uppy/core":91,"@uppy/utils/lib/Translator":152,"preact":47}],151:[function(require,module,exports){
var toArray = require('@uppy/utils/lib/toArray');
/*
  SITUATION
...
},{"@uppy/utils/lib/toArray":178}],152:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"./isDOMElement":169}],157:[function(require,module,exports){
var isDOMElement = require('./isDOMElement');
/**
 * Find a DOM element.
 *
...
},{"./isDOMElement":169}],158:[function(require,module,exports){
/**
...
},{"./utils/fallbackApi":161,"./utils/webkitGetAsEntryApi":162}],161:[function(require,module,exports){
...
},{"../../toArray":178}],162:[function(require,module,exports){
var toArray = require('../../toArray'); // Recursive function, calls the original callback() when the directory is entirely parsed.
...
},{"../../toArray":178}],163:[function(require,module,exports){
/**
...
},{"./CameraIcon":179,"./CameraScreen":180,"./PermissionsScreen":181,"./supportsMediaRecorder":185,"@uppy/core":91,"@uppy/utils/lib/Translator":152,"@uppy/utils/lib/canvasToBlob":153,"@uppy/utils/lib/getFileTypeExtension":165,"preact":47}],185:[function(require,module,exports){
